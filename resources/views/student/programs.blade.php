            ...
            <div class="row g-3">
                <div class="col-sm-6">
                    <div class="form-check">
                        <input id="lisans" name="program" value="lisans" type="radio" class="form-check-input"
                            onclick="$('#position').remove();count=0; ">
                ...
                <div class="col-sm-6">
                    <div class="form-check">
                        <input id="phd" name="program" type="radio" class="form-check-input" value="phd"
                            onclick="$('#position').remove();count=0; ">
                ...
                <div class="col-sm-6">
                    <div class="form-check">
                        <input type="radio" name="program" id="istekmal" class="form-check-input" value="istkmal"
                            onclick="$('#position').remove();count=0; ">
